				...
				<tr>
					...
					<td>
						<div class="select-field">
							<span></span>
							<?php
							$user_gender = ThemexUser::$data['user']['profile']['gender'];
							if ($user_gender == 'male') { $user_gender = 'man'; } else if ($user_gender == 'female') { $user_gender = 'women'; }
					...
					<td>
						<div class="select-field">
							...
							echo ThemexInterface::renderOption(array(
								'id' => 'age',
								'type' => 'select_age',
								'value' => (int)ThemexUser::$data['user']['profile']['age'],
								'wrap' => false,
							));
							?>
						</div>
