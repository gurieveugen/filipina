<div class="profile-preview">
	<div class="profile-image">
		<a href="<?php echo ThemexUser::$data['active_user']['profile_url']; ?>"><?php echo get_avatar($_GET['owner'], 200); ?></a>
	</div>
	...
	<div class="profile-options popup-container clearfix">
		<div class="profile-option">
			<form class="ajax-form" action="<?php echo AJAX_URL; ?>" method="POST">
				<?php if(ThemexUser::isFavorite($_GET['owner'])) { ?>
				...
				<?php } ?>
				<input type="hidden" name="user_favorite" value="<?php echo $_GET['owner']; ?>" />
		...
		<div class="profile-option">
			<a href="#gifts_listing" title="<?php _e('Send Gift', 'lovestory'); ?>" class="icon-gift colorbox inline" data-value="<?php echo $_GET['owner']; ?>"></a>
		</div>
		<?php } ?>
		<div class="profile-option">
